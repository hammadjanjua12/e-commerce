      ...
      <div className="pt-6">
        ...
        <section className="grid grid-col-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10">
          ...
          <div className="lg:col-span-1 max-auto max-w-2xl px-4 pb-16 sm:px-6 lg-max-w-7xl lg:px-8 lg:pb-24">
            ...
            <div
              className="py-10 lg:col-span-2 lg:col-start-1 lg:border-r
             lg:border-gray-200 lg:pb-16 lg:pr-8 lg:pt-6"
            >
              ...
              <Grid item xs={5}>
                ...
                <div className="flex items-center space-x-3">
                  <Rating
                    ...
                    readOnly
                  />
                  <p className="opacity-60">594 Rating</p>
                </div>
                <Box className="mt-5 space-y-3">
                  <Grid container alignItems="center" gap={2}>
                    <Grid item xs={2}>
                      <p className="text-bold">Excellent</p>
                    </Grid>
                    <Grid item xs={7}>
                      <LinearProgress
                  ...
                  <Grid container alignItems="center" gap={2}>
                    <Grid item xs={2}>
                      <p className="text-bold">Very Good</p>
                    </Grid>
                    <Grid item xs={7}>
                      <LinearProgress
                        sx={{ bgcolor: "#d0d0d0", borderRadius: 4, height: 7 }}
                  ...
                  <Grid container alignItems="center" gap={2}>
                    <Grid item xs={2}>
                      <p className="text-bold">Average</p>
                    </Grid>
                    <Grid item xs={7}>
                      <LinearProgress
                        sx={{ bgcolor: "#d0d0d0", borderRadius: 4, height: 7 }}
